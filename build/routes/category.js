...
var controller = new _category2.default();

// const jwtMiddleware = jwt()
var router = new _koaRouter2.default();

router.post('/api/category', _auth2.default.isUser, function () {
...
router.get('/api/category/:slug', function () {
...
router.delete('/api/category/:slug', _auth2.default.isAdmin, function () {
