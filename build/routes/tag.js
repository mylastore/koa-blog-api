...
var controller = new _tag2.default();
var route = new _koaRouter2.default();

route.post('/api/tag', _auth2.default.isUser, function () {
...
route.get('/api/tag/:slug', function () {
...
route.delete('/api/tag/:slug', _auth2.default.isAdmin, function () {
