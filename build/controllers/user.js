...
var UserController = function () {
  ...
  _createClass(UserController, [{
    ...
    value: function () {
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                _context12.next = 3;
                return _User2.default.findOne({ username: username, role: 'admin' }).select('settings').exec().then(function (res) {
                  ctx.body = res;
                }).catch(function (err) {
                  ctx.throw(422, err);
                });
      ...
      function getAdminSettings(_x14) {
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                username = ctx.params.username;
                _context14.next = 3;
                return _User2.default.exists({ username: username });
              ...
              case 3:
                ...
                _context14.prev = 5;
                _context14.next = 8;
                return _User2.default.findOneAndUpdate({ username: username }, username, { new: true, runValidators: true, context: 'query' });
          ...
          while (1) {
            switch (_context20.prev = _context20.next) {
              ...
              case 3:
                ...
                return _context20.abrupt('return', ctx.body = user);

              case 8:
                _context20.prev = 8;
                _context20.t0 = _context20['catch'](0);
                return _context20.abrupt('return', ctx.throw(_context20.t0));
    ...
    key: 'getStats',
    value: function () {
      var _ref21 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21(ctx) {
    ...
    key: 'publicProfile',
    value: function () {
      var _ref23 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee24(ctx) {
        var _this = this;
          ...
          while (1) {
            switch (_context24.prev = _context24.next) {
              case 0:
                ...
                blogs = void 0;
                _context24.next = 5;
                return _User2.default.findOne({ username: username }).select('_id username name email avatar crfeatedAt').exec().then(function (res) {
                  if (!res) {
                    ctx.throw(422, 'Oops! something is wrong. Try later.');
                  }
                  user = res;
                }).then(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee23() {
